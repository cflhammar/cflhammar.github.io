  ...
  return (
    <div className="start">
      ...
      <p>
        ...
        under middagen, kontakta Sara eller Frida senast 1 maj 2024 via email på:
        <br/>
        <span className="bold-text" onClick={(e) => {
          window.location.href = 'mailto:sofiaochfredrik2024@gmail.com';
        }}>sofiaochfredrik2024@gmail.com </span>
        <br/>
        eller via telefon:
        <br/>
        <span className="bold-text"> Frida: 073-4159167</span>
        <br/>
        <span className="bold-text"> Sara: 073-0986573</span>
      </p>
      ...
      <p>
        Om du ändå vill uppmärksamma vår dag med en gåva uppskattar vi ett bidrag till vår bröllopsresa via våra
        toastmadames.
